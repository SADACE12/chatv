              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Создание аккаунта', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.text)),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('Уже есть аккаунт? ', style: TextStyle(color: AppColors.textSub, fontSize: 14)),
                        GestureDetector(
